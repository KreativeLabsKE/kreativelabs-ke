    ...
    >
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
          <div>
            ...
            <div class="mt-4 md:mb-12 max-w-2xl">
              <h1
                class="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-gray-200"
              >
                What will you Build today?
              </h1>
              <p class="text-gray-600 dark:text-gray-400">
                Leverage our world-class teams to get your ideas and projects up
                and running quickly.
              </p>
            </div>
            <!-- End Title -->
            ...
            <blockquote class="hidden md:block relative max-w-sm">
              <svg
                class="absolute top-0 start-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-200 dark:text-gray-800"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      ...
                      <div class="col-span-full">
                        ...
                        <div class="relative">
                          ...
                          />
                          <label
                            for="hs-hero-signup-form-floating-input-company-message"
                            class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none peer-focus:text-xs peer-focus:-translate-y-1.5 peer-focus:text-gray-500 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:-translate-y-1.5 peer-[:not(:placeholder-shown)]:text-gray-500"
                            >Message</label
                          >
                        </div>
        ...
        <div class="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
          <svg
            class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-gray-500"
