  ...
  <section>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2
          class="text-3xl font-agbalumo font-bold md:text-4xl md:leading-tight dark:text-white"
        >
          Showcase
        </h2>
        <p class="mt-1 text-gray-600 dark:text-gray-400">
          We are constantly showing our awesome works in different kind of
          industries daily, see what we've been up to!
        </p>
      </div>
      <!-- End Title -->
      <div class="">
        <div class="relative flex items-center">
          <div class="relative flex max-w-[100vw] overflow-hidden py-5">
            <div
              class="flex justify-start w-full gap-6 pb-8 overflow-x-auto snap-x"
            >
              <div
              ...
              >
                ...
                >
                  <a
                    href="#"
                    title=""
                    class="flex shrink-0 aspect-w-4 aspect-h-3"
                    ><img
                  ...
                  <div
                    class="px-4 py-5 mt-auto border-t border-gray-100 sm:px-6"
                  >
                    <div class="flex items-center justify-between">
                      <div class="flex items-center space-x-2">
                        <Icon
                          name="ph:globe-bold"
                          class="w-5 h-auto font-medium text-gray-900"
                        />

                        <span class="text-sm font-medium text-gray-900">•</span>
                        <p class="text-sm font-medium text-gray-900">
                          <a href="#" title="" class="">Web App</a>
                        </p>
                      </div>
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div class="flex items-center space-x-2">
                        ...
                        <span class="text-sm font-medium text-gray-900">•</span>
                        <p class="text-sm font-medium text-gray-900">
                          <a href="#" title="" class="">Mobile App</a>
                        </p>
                      </div>
                      <a href="#" title="" class="" role="button"
                        ><svg
